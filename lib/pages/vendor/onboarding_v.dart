...
class onboardingVendor extends StatelessWidget {
  const onboardingVendor({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) => SafeArea(
        child: IntroductionScreen(
          pages: [
            PageViewModel(
                title: 'Iklankan semua keahlianmu',
                body:
                    'Dengan mengatur kategori jasa yaitu: \n Per Jam, Per Hari, Per Project',
                image: buildImage('assets/lottie/orang_ngambang.json'),
                decoration: getPageDecoration()),
            PageViewModel(
                title: 'Konsultasi dengan client',
...
// class onboardingVendor extends StatefulWidget {
//   onboardingVendor({Key? key}) : super(key: key);

//   @override
//   State<onboardingVendor> createState() => _onboardingVendorState();
// }

// class _onboardingVendorState extends State<onboardingVendor> {
...
//           children: [
//             Slide(
//               hero: LottieBuilder.asset('assets/lottie/orang_ngambang.json'),
//               title: 'Iklankan semua keahlianmu',
...
//                   .push(MaterialPageRoute(builder: (context) => vendorLogin()));
//             },
//             child: Text(
//               'Skip',
//               style: poppinsPutih.copyWith(
